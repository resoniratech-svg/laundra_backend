...
from app.api.v1 import (
    ...
    admin_customer_support, announcements, prepaid_packages, apple_wallet, google_wallet, cashier_shifts
)
...
router.include_router(cashier_shifts.router, prefix="/cashier-shifts", tags=["Cashier Shifts"])
...
router.include_router(google_wallet.router, prefix="", tags=["Google Wallet"])
